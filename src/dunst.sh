...
echo "foreground = \"$color0\"" >> $path
echo "background = \"$color1\"" >> $path
echo "frame_color = \"$color10\"" >> $path
echo "[urgency_normal]" >> $path
echo "foreground = \"$color15\"" >> $path
echo "background = \"$color3\"" >> $path
echo "frame_color = \"$color4\"" >> $path
